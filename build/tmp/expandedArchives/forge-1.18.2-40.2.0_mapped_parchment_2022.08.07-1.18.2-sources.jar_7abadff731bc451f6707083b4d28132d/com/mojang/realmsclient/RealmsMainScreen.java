...
public class RealmsMainScreen extends RealmsScreen {
   ...
   void renderMoreInfo(PoseStack pPoseStack, int p_86419_, int p_86420_, int p_86421_, int p_86422_, boolean p_86423_) {
      boolean flag = false;
      ...
      GuiComponent.blit(pPoseStack, p_86421_, p_86422_, f, 0.0F, 20, 20, 40, 20);
      if (flag) {
         ...
         if (pRealmsServer.state == RealmsServer.State.UNINITIALIZED) {
            ...
            if (!"0".equals(pRealmsServer.serverPing.nrOfPlayers)) {
               ...
               if (p_86890_ >= p_86888_ + 207 - RealmsMainScreen.this.font.width(s) && p_86890_ <= p_86888_ + 207 && p_86891_ >= p_86889_ + 1 && p_86891_ <= p_86889_ + 10 && p_86891_ < RealmsMainScreen.this.height - 40 && p_86891_ > 32 && !RealmsMainScreen.this.shouldShowPopup()) {
                  RealmsMainScreen.this.setTooltip(new TextComponent(pRealmsServer.serverPing.playerList));
               }
            }
            ...
            RealmsTextureManager.withBoundFace(pRealmsServer.ownerUUID, () -> {
               RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
               GuiComponent.blit(pPoseStack, p_86888_ - 36, p_86889_, 32, 32, 8.0F, 8.0F, 8, 8, 64, 64);
               GuiComponent.blit(pPoseStack, p_86888_ - 36, p_86889_, 32, 32, 40.0F, 8.0F, 8, 8, 64, 64);
            });
         }
      }
