...
public class ConfiguredStructureTagsProvider extends TagsProvider<ConfiguredStructureFeature<?, ?>> {
   ...
   @Deprecated
   public ConfiguredStructureTagsProvider(DataGenerator pGenerator) {
      super(pGenerator, BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE);
   }
   public ConfiguredStructureTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
      super(pGenerator, BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, modId, existingFileHelper);
   }
