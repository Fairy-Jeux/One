...
public class BiomeTagsProvider extends TagsProvider<Biome> {
   ...
   @Deprecated
   public BiomeTagsProvider(DataGenerator pGenerator) {
      super(pGenerator, BuiltinRegistries.BIOME);
   }
   public BiomeTagsProvider(DataGenerator pGenerator, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
      super(pGenerator, BuiltinRegistries.BIOME, modId, existingFileHelper);
   }
