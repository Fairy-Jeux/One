...
public class BuiltinRegistries {
   ...
   public static <V extends T, T> Holder<V> registerExact(Registry<T> pRegistry, String pLocation, V p_206383_) {
      return register((Registry<V>)pRegistry, new ResourceLocation(pLocation), p_206383_);
   }

   public static <T> Holder<T> register(Registry<T> pRegistry, String pLocation, T p_206399_) {
      return register(pRegistry, new ResourceLocation(pLocation), p_206399_);
   }

   public static <T> Holder<T> register(Registry<T> pRegistry, ResourceLocation pLocation, T p_206391_) {
      return register(pRegistry, ResourceKey.create(pRegistry.key(), pLocation), p_206391_);
   }

   public static <T> Holder<T> register(Registry<T> pRegistry, ResourceKey<T> pResourceKey, T p_206387_) {
      return ((WritableRegistry)pRegistry).register(pResourceKey, p_206387_, Lifecycle.stable());
   }
