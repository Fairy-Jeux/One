...
public class WorldgenRegistryDumpReport implements DataProvider {
   ...
   public void run(HashCache pCache) {
      ...
      RegistryAccess.knownRegistries().forEach((p_194713_) -> {
         dumpRegistryCap(pCache, path, registryaccess, dynamicops, p_194713_);
      });
      dumpRegistry(path, pCache, dynamicops, Registry.LEVEL_STEM_REGISTRY, registry1, LevelStem.CODEC);
   }
