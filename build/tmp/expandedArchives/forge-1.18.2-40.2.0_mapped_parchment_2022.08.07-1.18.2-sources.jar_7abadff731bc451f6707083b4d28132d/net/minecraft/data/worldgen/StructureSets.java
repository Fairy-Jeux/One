...
public interface StructureSets {
   ...
   static Holder<StructureSet> register(ResourceKey<StructureSet> p_211129_, StructureSet pStructureSet) {
      return BuiltinRegistries.register(BuiltinRegistries.STRUCTURE_SETS, p_211129_, pStructureSet);
   }

   static Holder<StructureSet> register(ResourceKey<StructureSet> p_211132_, Holder<ConfiguredStructureFeature<?, ?>> pStructures, StructurePlacement pPlacement) {
      return register(p_211132_, new StructureSet(pStructures, pPlacement));
   }
}