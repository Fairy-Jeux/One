...
public class TestCommand {
   ...
   private static int showPos(CommandSourceStack pSource, String p_127961_) throws CommandSyntaxException {
      ...
      if (!optional.isPresent()) {
         pSource.sendFailure(new TextComponent("Can't find a structure block that contains the targeted pos " + blockpos));
         return 0;
      } else {
         ...
         pSource.sendSuccess((new TextComponent("Position relative to " + s1 + ": ")).append(component), false);
