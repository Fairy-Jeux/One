...
public class ForceLoadCommand {
   ...
   private static int listForceLoad(CommandSourceStack pSource) {
      ...
      if (i > 0) {
         ...
         if (i == 1) {
            pSource.sendSuccess(new TranslatableComponent("commands.forceload.list.single", resourcekey.location(), s), false);
         } else {
            pSource.sendSuccess(new TranslatableComponent("commands.forceload.list.multiple", i, resourcekey.location(), s), false);
         }
      } else {
         pSource.sendFailure(new TranslatableComponent("commands.forceload.added.none", resourcekey.location()));
      }
   ...
   private static int removeAll(CommandSourceStack pSource) {
      ...
      pSource.sendSuccess(new TranslatableComponent("commands.forceload.removed.all", resourcekey.location()), true);
      return 0;
   }
      ...
      if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000) {
         ...
         if (i2 > 256L) {
            ...
            if (j2 == 0) {
               ...
               if (j2 == 1) {
                  pSource.sendSuccess(new TranslatableComponent("commands.forceload." + (pAdd ? "added" : "removed") + ".single", chunkpos, resourcekey.location()), true);
               } else {
                  ChunkPos chunkpos1 = new ChunkPos(i1, j1);
                  ChunkPos chunkpos2 = new ChunkPos(k1, l1);
                  pSource.sendSuccess(new TranslatableComponent("commands.forceload." + (pAdd ? "added" : "removed") + ".multiple", j2, resourcekey.location(), chunkpos1, chunkpos2), true);
               }
