...
public class ScheduleCommand {
   ...
   private static int schedule(CommandSourceStack pSource, Pair<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>> pFunction, int pTime, boolean pAppend) throws CommandSyntaxException {
      if (pTime == 0) {
         ...
         pFunction.getSecond().ifLeft((p_138453_) -> {
            ...
            pSource.sendSuccess(new TranslatableComponent("commands.schedule.created.function", resourcelocation, pTime, i), true);
         }).ifRight((p_138445_) -> {
            ...
            pSource.sendSuccess(new TranslatableComponent("commands.schedule.created.tag", resourcelocation, pTime, i), true);
         });
   ...
   private static int remove(CommandSourceStack pSource, String pFunction) throws CommandSyntaxException {
      ...
      if (i == 0) {
         ...
         pSource.sendSuccess(new TranslatableComponent("commands.schedule.cleared.success", i, pFunction), true);
         return i;
      }
   }
}