...
public class TextFilterClient implements AutoCloseable {
   ...
   private TextFilterClient(URL pChatEndpoint, URL pJoinEndpoint, URL pLeaveEndpoint, String pAuthKey, int pRuleId, String pServerId, String pRoomId, TextFilterClient.IgnoreStrategy pChatIgnoreStrategy, int p_212244_) {
