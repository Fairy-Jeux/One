...
public class ProfilerSamplerAdapter {
   ...
   private static MetricSampler samplerForProfilingPath(Supplier<ProfileCollector> p_146169_, String pName, MetricCategory pCategory) {
      return MetricSampler.create(pName, pCategory, () -> {
         ActiveProfiler.PathEntry activeprofiler$pathentry = p_146169_.get().getEntry(pName);
