...
public class GlowSquid extends Squid {
   ...
   public static boolean checkGlowSquideSpawnRules(EntityType<? extends LivingEntity> pEntityType, ServerLevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRand) {
