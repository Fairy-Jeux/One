...
public class PiglinAi {
   ...
   private static List<ItemStack> getBarterResponseItems(Piglin pPiglin) {
      ...
      return loottable.getRandomItems((new LootContext.Builder((ServerLevel)pPiglin.level)).withParameter(LootContextParams.THIS_ENTITY, pPiglin).withRandom(pPiglin.level.random).create(LootContextParamSets.PIGLIN_BARTER));
   }
