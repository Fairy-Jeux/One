...
public class Axolotl extends Animal implements LerpingModel, Bucketable {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
      ...
      if (pReason == MobSpawnType.BUCKET) {
         ...
         if (pSpawnData instanceof Axolotl.AxolotlGroupData) {
            ...
            pSpawnData = new Axolotl.AxolotlGroupData(Axolotl.Variant.getCommonSpawnVariant(this.level.random), Axolotl.Variant.getCommonSpawnVariant(this.level.random));
         }

         this.setVariant(((Axolotl.AxolotlGroupData)pSpawnData).getVariant(this.level.random));
         if (flag) {
            this.setAge(-24000);
         }
   ...
   private static boolean useRareVariant(Random pRandom) {
   ...
   protected PathNavigation createNavigation(Level pLevel) {
      return new Axolotl.AxolotlPathNavigation(this, pLevel);
   }
   ...
   public void saveToBucketTag(ItemStack pBucket) {
      Bucketable.saveDefaultDataToBucketTag(this, pBucket);
   ...
   public static void onStopAttacking(Axolotl pAxolotl) {
      Optional<LivingEntity> optional = pAxolotl.getBrain().getMemory(MemoryModuleType.ATTACK_TARGET);
   ...
   public static boolean checkAxolotlSpawnRules(EntityType<? extends LivingEntity> pEntityType, ServerLevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRand) {
   ...
   public static class AxolotlGroupData extends AgeableMob.AgeableMobGroupData {
      ...
      public Axolotl.Variant getVariant(Random pRandom) {
   ...
   static class AxolotlPathNavigation extends WaterBoundPathNavigation {
      AxolotlPathNavigation(Axolotl pAxolotl, Level pLevel) {
         super(pAxolotl, pLevel);
      }
   ...
   public static enum Variant {
      ...
      public static Axolotl.Variant getCommonSpawnVariant(Random pRandom) {
         return getSpawnVariant(pRandom, true);
      }

      public static Axolotl.Variant getRareSpawnVariant(Random pRandom) {
         return getSpawnVariant(pRandom, false);
      }

      private static Axolotl.Variant getSpawnVariant(Random pRandom, boolean pRare) {
         Axolotl.Variant[] aaxolotl$variant = Arrays.stream(BY_ID).filter((p_149252_) -> {
            return p_149252_.common == pRare;
         }).toArray((p_149244_) -> {
