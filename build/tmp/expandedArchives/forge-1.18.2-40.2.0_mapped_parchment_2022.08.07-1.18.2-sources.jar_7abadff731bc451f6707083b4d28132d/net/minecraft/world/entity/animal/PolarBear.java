...
public class PolarBear extends Animal implements NeutralMob {
   ...
   public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> pPolarBear, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom) {
      ...
      if (!holder.is(Biomes.FROZEN_OCEAN) && !holder.is(Biomes.DEEP_FROZEN_OCEAN)) {
         ...
         return isBrightEnoughToSpawn(pLevel, pPos) && pLevel.getBlockState(pPos.below()).is(BlockTags.POLAR_BEARS_SPAWNABLE_ON_IN_FROZEN_OCEAN);
      }
   }
