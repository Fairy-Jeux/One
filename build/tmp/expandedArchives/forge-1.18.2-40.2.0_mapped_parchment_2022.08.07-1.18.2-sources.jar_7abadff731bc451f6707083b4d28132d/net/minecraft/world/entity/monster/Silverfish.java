...
public class Silverfish extends Monster {
   ...
   public static boolean checkSilverfishSpawnRules(EntityType<Silverfish> pType, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom) {
      if (checkAnyLightMonsterSpawnRules(pType, pLevel, pSpawnType, pPos, pRandom)) {
