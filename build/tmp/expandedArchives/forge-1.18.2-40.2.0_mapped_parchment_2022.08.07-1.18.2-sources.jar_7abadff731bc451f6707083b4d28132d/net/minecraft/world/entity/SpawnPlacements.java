...
public class SpawnPlacements {
   ...
   public static <T extends Entity> boolean checkSpawnRules(EntityType<T> pEntityType, ServerLevelAccessor pServerLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom) {
      SpawnPlacements.Data spawnplacements$data = DATA_BY_TYPE.get(pEntityType);
   ...
   public interface SpawnPredicate<T extends Entity> {
      boolean test(EntityType<T> pEntityType, ServerLevelAccessor pServerLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom);
   }
