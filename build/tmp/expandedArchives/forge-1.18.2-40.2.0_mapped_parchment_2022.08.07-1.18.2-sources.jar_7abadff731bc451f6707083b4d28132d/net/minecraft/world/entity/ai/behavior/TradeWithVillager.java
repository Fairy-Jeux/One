...
public class TradeWithVillager extends Behavior<Villager> {
   ...
   private static Set<Item> figureOutWhatIAmWillingToTrade(Villager pVillager, Villager pOther) {
      ImmutableSet<Item> immutableset = pOther.getVillagerData().getProfession().getRequestedItems();
      ImmutableSet<Item> immutableset1 = pVillager.getVillagerData().getProfession().getRequestedItems();
