...
public class Goat extends Animal {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
      ...
      this.setScreamingGoat(pLevel.getRandom().nextDouble() < 0.02D);
   ...
   public static boolean checkGoatSpawnRules(EntityType<? extends Animal> pType, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, Random pRandom) {
