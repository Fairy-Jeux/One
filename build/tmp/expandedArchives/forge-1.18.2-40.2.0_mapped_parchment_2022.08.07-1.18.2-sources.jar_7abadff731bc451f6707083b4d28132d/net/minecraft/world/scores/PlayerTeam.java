...
public class PlayerTeam extends Team {
   ...
   public PlayerTeam(Scoreboard pScoreboard, String pName) {
      ...
      this.name = pName;
      this.displayName = new TextComponent(pName);
      this.displayNameStyle = Style.EMPTY.withInsertion(pName).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(pName)));
   }
   ...
   public void setPlayerPrefix(@Nullable Component pPlayerPrefix) {
      this.playerPrefix = pPlayerPrefix == null ? TextComponent.EMPTY : pPlayerPrefix;
      this.scoreboard.onTeamChanged(this);
   }
   ...
   public void setPlayerSuffix(@Nullable Component pPlayerSuffix) {
      this.playerSuffix = pPlayerSuffix == null ? TextComponent.EMPTY : pPlayerSuffix;
      this.scoreboard.onTeamChanged(this);
   }
   ...
   public MutableComponent getFormattedName(Component pFormattedName) {
      MutableComponent mutablecomponent = (new TextComponent("")).append(this.playerPrefix).append(pFormattedName).append(this.playerSuffix);
      ChatFormatting chatformatting = this.getColor();
      if (chatformatting != ChatFormatting.RESET) {
         mutablecomponent.withStyle(chatformatting);
      }
