...
public class ChunkStatus extends net.minecraftforge.registries.ForgeRegistryEntry<ChunkStatus> {
   ...
   public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> generate(Executor pExecutor, ServerLevel pLevel, ChunkGenerator pGenerator, StructureManager pStructureManager, ThreadedLevelLightEngine pLightEngine, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> pTask, List<ChunkAccess> pNeighbouringChunks, boolean p_187796_) {
      ChunkAccess chunkaccess = pNeighbouringChunks.get(pNeighbouringChunks.size() / 2);
      ProfiledDuration profiledduration = JvmProfiler.INSTANCE.onChunkGenerate(chunkaccess.getPos(), pLevel.dimension(), this.name);
      CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.generationTask.doWork(this, pExecutor, pLevel, pGenerator, pStructureManager, pLightEngine, pTask, pNeighbouringChunks, chunkaccess, p_187796_);
   ...
   interface GenerationTask {
      CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> doWork(ChunkStatus pStatus, Executor pExecutor, ServerLevel pLevel, ChunkGenerator pGenerator, StructureManager pStructureManager, ThreadedLevelLightEngine pLightEngine, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> pTask, List<ChunkAccess> pNeighboringChunks, ChunkAccess pChunk, boolean p_187880_);
   }
   ...
   interface SimpleGenerationTask extends ChunkStatus.GenerationTask {
      default CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> doWork(ChunkStatus pStatus, Executor pExecutor, ServerLevel pLevel, ChunkGenerator pGenerator, StructureManager pStructureManager, ThreadedLevelLightEngine pLightEngine, Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> pTask, List<ChunkAccess> pNeighboringChunks, ChunkAccess pChunk, boolean p_187891_) {
         if (p_187891_ || !pChunk.getStatus().isOrAfter(pStatus)) {
