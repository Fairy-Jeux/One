...
public class WoodlandMansionPieces {
   ...
   static class MansionPiecePlacer {
      ...
      private void traverseOuterWalls(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, WoodlandMansionPieces.PlacementData pData, WoodlandMansionPieces.SimpleGrid pGrid, Direction pDirection, int pStartX, int pStartY, int p_73796_, int p_73797_) {
         int i = pStartX;
         int j = pStartY;
         ...
         do {
            if (!WoodlandMansionPieces.MansionGrid.isHouse(pGrid, i + pDirection.getStepX(), j + pDirection.getStepZ())) {
               ...
               if (i != p_73796_ || j != p_73797_ || direction != pDirection) {
         ...
         } while(i != p_73796_ || j != p_73797_ || direction != pDirection);

      }

      private void createRoof(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, BlockPos pPos, Rotation pRotation, WoodlandMansionPieces.SimpleGrid p_73807_, @Nullable WoodlandMansionPieces.SimpleGrid p_73808_) {
         for(int i = 0; i < p_73807_.height; ++i) {
            for(int j = 0; j < p_73807_.width; ++j) {
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j, i) && !flag) {
                  pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof", $$27.above(3), pRotation));
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j + 1, i)) {
                     ...
                     pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockpos1, pRotation));
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j - 1, i)) {
                     ...
                     pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockpos5, pRotation.getRotated(Rotation.CLOCKWISE_180)));
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j, i - 1)) {
                     ...
                     pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockpos6, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j, i + 1)) {
                     ...
                     pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", blockpos7, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                  }
               }
            }
         }
               ...
               for(int i1 = 0; i1 < p_73807_.width; ++i1) {
                  ...
                  if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k) && flag1) {
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1 + 1, k)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockpos8, pRotation));
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1 - 1, k)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockpos9, pRotation.getRotated(Rotation.CLOCKWISE_180)));
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k - 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockpos10, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k + 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", blockpos11, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1 + 1, k)) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k - 1)) {
                           ...
                           pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockpos12, pRotation));
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k + 1)) {
                           ...
                           pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockpos13, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                        }
                     }
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1 - 1, k)) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k - 1)) {
                           ...
                           pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockpos14, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, i1, k + 1)) {
                           ...
                           pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", blockpos15, pRotation.getRotated(Rotation.CLOCKWISE_180)));
                        }
                     }
                  }
               }
               ...
               if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1, l) && !flag2) {
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1 + 1, l)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1, l + 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockpos2, pRotation));
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockpos18, pRotation));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1, l - 1)) {
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockpos16, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1 + 1, l - 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockpos19, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                     }
                  }
                  ...
                  if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1 - 1, l)) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1, l + 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockpos20, pRotation.getRotated(Rotation.CLOCKWISE_90)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1 - 1, l + 1)) {
                        ...
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockpos21, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                     }

                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1, l - 1)) {
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", blockpos17, pRotation.getRotated(Rotation.CLOCKWISE_180)));
                     } else if (WoodlandMansionPieces.MansionGrid.isHouse(p_73807_, j1 - 1, l - 1)) {
                        BlockPos blockpos22 = blockpos17.relative(pRotation.rotate(Direction.SOUTH), 1);
                        pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", blockpos22, pRotation.getRotated(Rotation.CLOCKWISE_180)));
                     }
                  }
               }
            }
      ...
      private void addRoom1x2(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, BlockPos pPos, Rotation pRotation, Direction p_73826_, Direction p_73827_, WoodlandMansionPieces.FloorRoomCollection pFloorRooms, boolean p_73829_) {
         if (p_73827_ == Direction.EAST && p_73826_ == Direction.SOUTH) {
            BlockPos blockpos13 = pPos.relative(pRotation.rotate(Direction.EAST), 1);
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos13, pRotation));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos12, pRotation, Mirror.LEFT_RIGHT));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos11, pRotation.getRotated(Rotation.CLOCKWISE_180)));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos10, pRotation, Mirror.FRONT_BACK));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos9, pRotation.getRotated(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos8, pRotation.getRotated(Rotation.CLOCKWISE_90)));
            ...
            blockpos7 = blockpos7.relative(pRotation.rotate(Direction.SOUTH), 6);
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos7, pRotation.getRotated(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2SideEntrance(this.random, p_73829_), blockpos6, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2FrontEntrance(this.random, p_73829_), blockpos5, pRotation));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2FrontEntrance(this.random, p_73829_), blockpos4, pRotation.getRotated(Rotation.CLOCKWISE_180)));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2FrontEntrance(this.random, p_73829_), blockpos3, pRotation.getRotated(Rotation.CLOCKWISE_90)));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2FrontEntrance(this.random, p_73829_), blockpos2, pRotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
         } else if (p_73827_ == Direction.UP && p_73826_ == Direction.EAST) {
            BlockPos blockpos1 = pPos.relative(pRotation.rotate(Direction.EAST), 15);
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2Secret(this.random), blockpos1, pRotation.getRotated(Rotation.CLOCKWISE_90)));
            ...
            pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get1x2Secret(this.random), blockpos, pRotation));
         }

      }

      private void addRoom2x2(List<WoodlandMansionPieces.WoodlandMansionPiece> pPieces, BlockPos pPos, Rotation pRotation, Direction p_73819_, Direction p_73820_, WoodlandMansionPieces.FloorRoomCollection pFloorRooms) {
         int i = 0;
         int j = 0;
         ...
         pPieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, pFloorRooms.get2x2(this.random), blockpos, rotation, mirror));
      }
   ...
   static class SimpleGrid {
      ...
      public void set(int pX, int pY, int p_73878_) {
         if (pX >= 0 && pX < this.width && pY >= 0 && pY < this.height) {
            this.grid[pX][pY] = p_73878_;
         }

      }

      public void set(int pMinX, int pMinY, int pMaxX, int pMaxY, int p_73889_) {
      ...
      public void setif(int pX, int pY, int p_73882_, int p_73883_) {
         if (this.get(pX, pY) == p_73882_) {
            this.set(pX, pY, p_73883_);
         }
