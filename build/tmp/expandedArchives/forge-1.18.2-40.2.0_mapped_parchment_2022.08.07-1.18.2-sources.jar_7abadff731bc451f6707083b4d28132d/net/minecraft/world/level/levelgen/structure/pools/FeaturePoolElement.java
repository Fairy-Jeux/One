...
public class FeaturePoolElement extends StructurePoolElement {
   ...
   public boolean place(StructureManager pStructureManager, WorldGenLevel pLevel, StructureFeatureManager pStructureFeatureManager, ChunkGenerator pGenerator, BlockPos pPos, BlockPos p_210222_, Rotation pRotation, BoundingBox pBox, Random pRandom, boolean pKeepJigsaws) {
      return this.feature.value().place(pLevel, pGenerator, pRandom, pPos);
   }
