...
public class PerlinNoise {
   ...
   /** @deprecated */
   @Deprecated
   public static PerlinNoise createLegacyForLegacyNetherBiome(RandomSource pRandomSource, int p_210647_, DoubleList p_210648_) {
      return new PerlinNoise(pRandomSource, Pair.of(p_210647_, p_210648_), false);
   }
   ...
   public static PerlinNoise create(RandomSource pRandomSource, int p_192875_, double p_192876_, double... p_192877_) {
      DoubleArrayList doublearraylist = new DoubleArrayList(p_192877_);
      doublearraylist.add(0, p_192876_);
      return new PerlinNoise(pRandomSource, Pair.of(p_192875_, doublearraylist), true);
   }
   ...
   protected PerlinNoise(RandomSource pRandomSource, Pair<Integer, DoubleList> pAmplitudes, boolean p_192871_) {
      this.firstOctave = pAmplitudes.getFirst();
      ...
      if (p_192871_) {
         PositionalRandomFactory positionalrandomfactory = pRandomSource.forkPositional();
         ...
         for(int i1 = j - 1; i1 >= 0; --i1) {
            if (i1 < i) {
               ...
               if (d1 != 0.0D) {
                  this.noiseLevels[i1] = new ImprovedNoise(pRandomSource);
               } else {
