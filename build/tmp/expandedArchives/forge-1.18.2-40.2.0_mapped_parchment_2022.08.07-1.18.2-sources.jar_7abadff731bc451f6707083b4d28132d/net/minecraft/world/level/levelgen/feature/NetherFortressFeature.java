...
public class NetherFortressFeature extends StructureFeature<NoneFeatureConfiguration> {
   ...
   public NetherFortressFeature(Codec<NoneFeatureConfiguration> pCodec) {
      super(pCodec, PieceGeneratorSupplier.simple(NetherFortressFeature::checkLocation, NetherFortressFeature::generatePieces));
   }
