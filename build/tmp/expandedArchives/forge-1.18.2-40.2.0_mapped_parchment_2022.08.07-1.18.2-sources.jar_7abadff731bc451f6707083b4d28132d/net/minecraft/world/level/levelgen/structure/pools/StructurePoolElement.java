...
public abstract class StructurePoolElement {
   ...
   public abstract boolean place(StructureManager pStructureManager, WorldGenLevel pLevel, StructureFeatureManager pStructureFeatureManager, ChunkGenerator pGenerator, BlockPos pPos, BlockPos p_210488_, Rotation pRotation, BoundingBox pBox, Random pRandom, boolean pKeepJigsaws);
