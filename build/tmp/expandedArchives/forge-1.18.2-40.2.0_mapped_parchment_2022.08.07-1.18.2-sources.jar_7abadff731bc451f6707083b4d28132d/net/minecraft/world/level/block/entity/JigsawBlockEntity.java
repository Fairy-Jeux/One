...
public class JigsawBlockEntity extends BlockEntity {
   ...
   public void generate(ServerLevel pLevel, int pLevels, boolean pKeepJigsaws) {
      ...
      structuretemplate.fillFromWorld(pLevel, blockpos, new Vec3i(1, 1, 1), false, (Block)null);
      ...
      JigsawPlacement.addPieces(pLevel.registryAccess(), poolelementstructurepiece, pLevels, PoolElementStructurePiece::new, chunkgenerator, structuremanager, list, random, pLevel);

      for(PoolElementStructurePiece poolelementstructurepiece1 : list) {
         poolelementstructurepiece1.place(pLevel, structurefeaturemanager, chunkgenerator, random, BoundingBox.infinite(), blockpos, pKeepJigsaws);
      }
