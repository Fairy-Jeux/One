...
public record StructureSet(List<StructureSet.StructureSelectionEntry> structures, StructurePlacement placement) {
   ...
   public StructureSet(Holder<ConfiguredStructureFeature<?, ?>> p_210007_, StructurePlacement pPlacement) {
      this(List.of(new StructureSet.StructureSelectionEntry(p_210007_, 1)), pPlacement);
   }

   public static StructureSet.StructureSelectionEntry entry(Holder<ConfiguredStructureFeature<?, ?>> pStructure, int pWeight) {
      return new StructureSet.StructureSelectionEntry(pStructure, pWeight);
   }

   public static StructureSet.StructureSelectionEntry entry(Holder<ConfiguredStructureFeature<?, ?>> pStructure) {
