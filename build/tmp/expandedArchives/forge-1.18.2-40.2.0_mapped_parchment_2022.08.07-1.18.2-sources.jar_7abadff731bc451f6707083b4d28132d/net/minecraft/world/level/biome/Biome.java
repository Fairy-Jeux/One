...
public final class Biome extends net.minecraftforge.registries.ForgeRegistryEntry.UncheckedRegistryEntry<Biome> {
   ...
   /** @deprecated */
   @Deprecated
   public static Biome.BiomeCategory getBiomeCategory(Holder<Biome> pHolder) {
      return pHolder.value().getBiomeCategory();
   }
   ...
   public static class BiomeBuilder {
      ...
      public static Biome.BiomeBuilder from(Biome pBiome) {
         return (new Biome.BiomeBuilder()).precipitation(pBiome.getPrecipitation()).biomeCategory(pBiome.getBiomeCategory()).temperature(pBiome.getBaseTemperature()).downfall(pBiome.getDownfall()).specialEffects(pBiome.getSpecialEffects()).generationSettings(pBiome.getGenerationSettings()).mobSpawnSettings(pBiome.getMobSettings());
      }
   ...
   public static enum BiomeCategory implements StringRepresentable {
      ...
      private BiomeCategory(String pName) {
         this.name = pName;
      }
