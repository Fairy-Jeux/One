...
public class FlowerBlock extends BushBlock {
   ...
   public FlowerBlock(MobEffect pSuspiciousStewEffect, int pEffectDuration, BlockBehaviour.Properties pProperties) {
      ...
      this.suspiciousStewEffectSupplier = net.minecraftforge.registries.RegistryObject.create(pSuspiciousStewEffect.getRegistryName(), net.minecraftforge.registries.ForgeRegistries.MOB_EFFECTS);
