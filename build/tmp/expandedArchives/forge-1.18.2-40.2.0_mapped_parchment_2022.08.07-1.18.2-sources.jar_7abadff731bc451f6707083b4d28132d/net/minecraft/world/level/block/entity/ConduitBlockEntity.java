...
public class ConduitBlockEntity extends BlockEntity {
   ...
   private static void animationTick(Level pLevel, BlockPos pPos, List<BlockPos> pPositions, @Nullable Entity pEntity, int pTickCount) {
      ...
      if (pEntity != null) {
         ...
         float f3 = (-0.5F + random.nextFloat()) * (3.0F + pEntity.getBbWidth());
         float f4 = -1.0F + random.nextFloat() * pEntity.getBbHeight();
         float f5 = (-0.5F + random.nextFloat()) * (3.0F + pEntity.getBbWidth());
