...
public class EndCityPieces {
   ...
   public static class EndCityPiece extends TemplateStructurePiece {
      public EndCityPiece(StructureManager pStructureManager, String pName, BlockPos pPos, Rotation pRotation, boolean p_71203_) {
         super(StructurePieceType.END_CITY_PIECE, 0, pStructureManager, makeResourceLocation(pName), pName, makeSettings(p_71203_, pRotation), pPos);
      }
      ...
      private static StructurePlaceSettings makeSettings(boolean p_162430_, Rotation pRotation) {
