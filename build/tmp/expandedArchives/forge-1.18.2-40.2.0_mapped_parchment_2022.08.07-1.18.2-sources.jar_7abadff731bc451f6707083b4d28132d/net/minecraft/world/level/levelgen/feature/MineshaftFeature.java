...
public class MineshaftFeature extends StructureFeature<MineshaftConfiguration> {
   public MineshaftFeature(Codec<MineshaftConfiguration> pCodec) {
      super(pCodec, PieceGeneratorSupplier.simple(MineshaftFeature::checkLocation, MineshaftFeature::generatePieces));
   }
   ...
   public static enum Type implements StringRepresentable {
      ...
      private Type(String pName, Block pWood, Block pPlanks, Block pFence) {
         this.name = pName;
         this.woodState = pWood.defaultBlockState();
         this.planksState = pPlanks.defaultBlockState();
         this.fenceState = pFence.defaultBlockState();
      }
