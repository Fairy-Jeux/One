...
public class GravityProcessor extends StructureProcessor {
   ...
   @Nullable
   public StructureTemplate.StructureBlockInfo processBlock(LevelReader pLevel, BlockPos p_74110_, BlockPos pPos, StructureTemplate.StructureBlockInfo pBlockInfo, StructureTemplate.StructureBlockInfo pRelativeBlockInfo, StructurePlaceSettings pSettings) {
      ...
      int i = pLevel.getHeight(heightmap$types, pRelativeBlockInfo.pos.getX(), pRelativeBlockInfo.pos.getZ()) + this.offset;
      int j = pBlockInfo.pos.getY();
      return new StructureTemplate.StructureBlockInfo(new BlockPos(pRelativeBlockInfo.pos.getX(), i + j, pRelativeBlockInfo.pos.getZ()), pRelativeBlockInfo.state, pRelativeBlockInfo.nbt);
   }
