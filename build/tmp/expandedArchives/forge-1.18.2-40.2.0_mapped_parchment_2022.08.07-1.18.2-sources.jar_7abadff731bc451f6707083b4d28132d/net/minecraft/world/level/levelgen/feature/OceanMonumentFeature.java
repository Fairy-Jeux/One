...
public class OceanMonumentFeature extends StructureFeature<NoneFeatureConfiguration> {
   public OceanMonumentFeature(Codec<NoneFeatureConfiguration> pCodec) {
      super(pCodec, PieceGeneratorSupplier.simple(OceanMonumentFeature::checkLocation, OceanMonumentFeature::generatePieces));
   }
   ...
   public static PiecesContainer regeneratePiecesAfterLoad(ChunkPos pChunkPos, long pSeed, PiecesContainer p_191023_) {
