...
public abstract class NoiseBasedStateProvider extends BlockStateProvider {
   ...
   protected NoiseBasedStateProvider(long pSeed, NormalNoise.NoiseParameters pParamaters, float pScale) {
      this.seed = pSeed;
      this.parameters = pParamaters;
      this.scale = pScale;
      this.noise = NormalNoise.create(new WorldgenRandom(new LegacyRandomSource(pSeed)), pParamaters);
   }
