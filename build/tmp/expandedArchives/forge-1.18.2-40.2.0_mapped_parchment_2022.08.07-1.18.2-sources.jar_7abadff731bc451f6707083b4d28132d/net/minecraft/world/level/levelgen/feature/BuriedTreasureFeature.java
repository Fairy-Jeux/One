...
public class BuriedTreasureFeature extends StructureFeature<ProbabilityFeatureConfiguration> {
   ...
   public BuriedTreasureFeature(Codec<ProbabilityFeatureConfiguration> pCodec) {
      super(pCodec, PieceGeneratorSupplier.simple(BuriedTreasureFeature::checkLocation, BuriedTreasureFeature::generatePieces));
   }
