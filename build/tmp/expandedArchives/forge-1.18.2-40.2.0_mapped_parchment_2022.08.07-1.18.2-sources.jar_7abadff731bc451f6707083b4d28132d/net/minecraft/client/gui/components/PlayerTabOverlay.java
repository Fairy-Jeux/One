...
public class PlayerTabOverlay extends GuiComponent {
   ...
   public void render(PoseStack pPoseStack, int pWidth, Scoreboard pScoreboard, @Nullable Objective pObjective) {
      ...
      fill(pPoseStack, pWidth / 2 - l1 / 2 - 1, k1 - 1, pWidth / 2 + l1 / 2 + 1, k1 + j4 * 9, Integer.MIN_VALUE);
      ...
      for(int i5 = 0; i5 < i4; ++i5) {
         ...
         if (i5 < list.size()) {
            ...
            if (flag) {
               ...
               int i3 = 8 + (flag1 ? 8 : 0);
               int j3 = 8 * (flag1 ? -1 : 1);
               GuiComponent.blit(pPoseStack, k2, l2, 8, 8, 8.0F, (float)i3, 8, j3, 64, 64);
               if (player != null && player.isModelPartShown(PlayerModelPart.HAT)) {
                  int k3 = 8 + (flag1 ? 8 : 0);
                  int l3 = 8 * (flag1 ? -1 : 1);
                  GuiComponent.blit(pPoseStack, k2, l2, 8, 8, 40.0F, (float)k3, 8, l3, 64, 64);
               }
            ...
            if (pObjective != null && playerinfo1.getGameMode() != GameType.SPECTATOR) {
               ...
               int i6 = l5 + l;
               if (i6 - l5 > 5) {
                  this.renderTablistScore(pObjective, l2, gameprofile.getName(), l5, i6, playerinfo1, pPoseStack);
               }
            }
      ...
      if (list2 != null) {
         ...
         for(FormattedCharSequence formattedcharsequence3 : list2) {
            ...
            this.minecraft.font.drawShadow(pPoseStack, formattedcharsequence3, (float)(pWidth / 2 - k5 / 2), (float)k1, -1);
            k1 += 9;
         }
      }
