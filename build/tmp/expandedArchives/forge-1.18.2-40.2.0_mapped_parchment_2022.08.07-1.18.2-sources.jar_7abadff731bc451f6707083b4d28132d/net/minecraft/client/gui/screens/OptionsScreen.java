...
public class OptionsScreen extends Screen {
   ...
   public static CycleButton<Difficulty> createDifficultyButton(int pAmount, int pWidth, int pHeight, String pTranslatableKey, Minecraft pMinecraft) {
      return CycleButton.builder(Difficulty::getDisplayName).withValues(Difficulty.values()).withInitialValue(pMinecraft.level.getDifficulty()).create(pWidth / 2 - 155 + pAmount % 2 * 160, pHeight / 6 - 12 + 24 * (pAmount >> 1), 150, 20, new TranslatableComponent(pTranslatableKey), (p_193854_, p_193855_) -> {
