...
public class PresetFlatWorldScreen extends Screen {
   ...
   private static void preset(Component pName, ItemLike pIcon, ResourceKey<Biome> pBiome, Set<ResourceKey<StructureSet>> pStructures, boolean p_210854_, boolean p_210855_, FlatLayerInfo... p_210856_) {
      PRESETS.add(new PresetFlatWorldScreen.PresetInfo(pIcon.asItem(), pName, (p_210848_) -> {
         ...
         HolderSet.Direct<StructureSet> direct = HolderSet.direct(pStructures.stream().flatMap((p_210841_) -> {
         ...
         flatlevelgeneratorsettings.setBiome(registry.getOrCreateHolder(pBiome));
   ...
   class PresetsList extends ObjectSelectionList<PresetFlatWorldScreen.PresetsList.Entry> {
      ...
      public class Entry extends ObjectSelectionList.Entry<PresetFlatWorldScreen.PresetsList.Entry> {
         ...
         public Entry(PresetFlatWorldScreen.PresetInfo pPreset) {
            this.preset = pPreset;
         }
