...
public class WinScreen extends Screen {
   ...
   private void wrapCreditsIO(String pCreditsLocation, WinScreen.CreditsReader pReader) {
      ...
      try {
         resource = this.minecraft.getResourceManager().getResource(new ResourceLocation(pCreditsLocation));
         InputStreamReader inputstreamreader = new InputStreamReader(resource.getInputStream(), StandardCharsets.UTF_8);
         pReader.read(inputstreamreader);
   ...
   interface CreditsReader {
      void read(InputStreamReader pReader) throws IOException;
   }
}