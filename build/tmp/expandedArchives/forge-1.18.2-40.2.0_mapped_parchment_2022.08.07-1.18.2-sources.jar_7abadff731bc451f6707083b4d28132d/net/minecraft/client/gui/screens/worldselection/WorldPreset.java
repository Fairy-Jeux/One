...
public abstract class WorldPreset {
   ...
   static NoiseBasedChunkGenerator fixedBiomeGenerator(RegistryAccess pAccess, long pSeed, ResourceKey<NoiseGeneratorSettings> pSettings) {
      Registry<Biome> registry = pAccess.registryOrThrow(Registry.BIOME_REGISTRY);
      Registry<StructureSet> registry1 = pAccess.registryOrThrow(Registry.STRUCTURE_SET_REGISTRY);
      Registry<NormalNoise.NoiseParameters> registry2 = pAccess.registryOrThrow(Registry.NOISE_REGISTRY);
      Registry<NoiseGeneratorSettings> registry3 = pAccess.registryOrThrow(Registry.NOISE_GENERATOR_SETTINGS_REGISTRY);
      return new NoiseBasedChunkGenerator(registry1, registry2, new FixedBiomeSource(registry.getOrCreateHolder(Biomes.PLAINS)), pSeed, registry3.getOrCreateHolder(pSettings));
   }
