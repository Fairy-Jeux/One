...
public class WorldGenSettingsComponent implements Widget {
   ...
   public WorldGenSettings makeSettings(boolean pHardcore) {
      OptionalLong optionallong = WorldGenSettings.parseSeed(this.seedEdit.getValue());
      return this.settings.withSeed(pHardcore, optionallong);
   }
   ...
   void updateDataPacks(WorldStem pWorldStem) {
      this.settings = pWorldStem.worldData().worldGenSettings();
