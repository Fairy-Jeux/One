      ...
      KeyEntry(final KeyMapping pKey, final Component pName) {
         ...
         this.changeButton = new Button(0, 0, 75 + 20 /* Forge: Add space */, 20, pName, (p_193939_) -> {
            ...
            protected MutableComponent createNarrationMessage() {
               return pKey.isUnbound() ? new TranslatableComponent("narrator.controls.unbound", pName) : new TranslatableComponent("narrator.controls.bound", pName, super.createNarrationMessage());
            }
         };
         this.resetButton = new Button(0, 0, 50, 20, new TranslatableComponent("controls.reset"), (p_193935_) -> {
            ...
            protected MutableComponent createNarrationMessage() {
               return new TranslatableComponent("narrator.controls.reset", pName);
            }
         };
      }
