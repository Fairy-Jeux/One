...
public class IntegratedServer extends MinecraftServer {
   ...
   public IntegratedServer(Thread pServerThread, Minecraft pMinecraft, LevelStorageSource.LevelStorageAccess pStorageSource, PackRepository pPackRepository, WorldStem p_205657_, MinecraftSessionService pSessionService, GameProfileRepository pProfileRepository, GameProfileCache pProfileCache, ChunkProgressListenerFactory pProgressListenerFactory) {
      super(pServerThread, pStorageSource, pPackRepository, p_205657_, pMinecraft.getProxy(), pMinecraft.getFixerUpper(), pSessionService, pProfileRepository, pProfileCache, pProgressListenerFactory);
