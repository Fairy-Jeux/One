...
public class BoatRenderer extends EntityRenderer<Boat> {
   ...
   public BoatRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
      this.shadowRadius = 0.8F;
      this.boatResources = Stream.of(Boat.Type.values()).collect(ImmutableMap.toImmutableMap((p_173938_) -> {
         return p_173938_;
      }, (p_173941_) -> {
         return Pair.of(new ResourceLocation("textures/entity/boat/" + p_173941_.getName() + ".png"), new BoatModel(pContext.bakeLayer(ModelLayers.createBoatModelName(p_173941_))));
      }));
   }
