...
public class PandaRenderer extends MobRenderer<Panda, PandaModel<Panda>> {
   ...
   private float getAngle(float p_115625_, float p_115626_, int p_115627_, float pPartialTick, float p_115629_) {
      return (float)p_115627_ < p_115629_ ? Mth.lerp(pPartialTick, p_115625_, p_115626_) : p_115625_;
   }
}