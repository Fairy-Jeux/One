...
public abstract class NbtComponent extends BaseComponent implements ContextAwareComponent {
   ...
   public static class BlockNbtComponent extends NbtComponent {
      ...
      public boolean equals(Object pOther) {
         if (this == pOther) {
            return true;
         } else if (!(pOther instanceof NbtComponent.BlockNbtComponent)) {
            return false;
         } else {
            NbtComponent.BlockNbtComponent nbtcomponent$blocknbtcomponent = (NbtComponent.BlockNbtComponent)pOther;
            return Objects.equals(this.posPattern, nbtcomponent$blocknbtcomponent.posPattern) && Objects.equals(this.nbtPathPattern, nbtcomponent$blocknbtcomponent.nbtPathPattern) && super.equals(pOther);
         }
      }
   ...
   public static class EntityNbtComponent extends NbtComponent {
      ...
      public boolean equals(Object pOther) {
         if (this == pOther) {
            return true;
         } else if (!(pOther instanceof NbtComponent.EntityNbtComponent)) {
            return false;
         } else {
            NbtComponent.EntityNbtComponent nbtcomponent$entitynbtcomponent = (NbtComponent.EntityNbtComponent)pOther;
            return Objects.equals(this.selectorPattern, nbtcomponent$entitynbtcomponent.selectorPattern) && Objects.equals(this.nbtPathPattern, nbtcomponent$entitynbtcomponent.nbtPathPattern) && super.equals(pOther);
         }
      }
   ...
   public static class StorageNbtComponent extends NbtComponent {
      ...
      public boolean equals(Object pOther) {
         if (this == pOther) {
            return true;
         } else if (!(pOther instanceof NbtComponent.StorageNbtComponent)) {
            return false;
         } else {
            NbtComponent.StorageNbtComponent nbtcomponent$storagenbtcomponent = (NbtComponent.StorageNbtComponent)pOther;
            return Objects.equals(this.id, nbtcomponent$storagenbtcomponent.id) && Objects.equals(this.nbtPathPattern, nbtcomponent$storagenbtcomponent.nbtPathPattern) && super.equals(pOther);
         }
      }
