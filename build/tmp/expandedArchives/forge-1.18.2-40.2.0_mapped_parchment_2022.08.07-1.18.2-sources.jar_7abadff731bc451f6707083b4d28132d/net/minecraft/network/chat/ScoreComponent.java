...
public class ScoreComponent extends BaseComponent implements ContextAwareComponent {
   ...
   public boolean equals(Object pOther) {
      if (this == pOther) {
         return true;
      } else if (!(pOther instanceof ScoreComponent)) {
         return false;
      } else {
         ScoreComponent scorecomponent = (ScoreComponent)pOther;
         return this.name.equals(scorecomponent.name) && this.objective.equals(scorecomponent.objective) && super.equals(pOther);
      }
   }
