...
public class TextComponent extends BaseComponent {
   ...
   public boolean equals(Object pOther) {
      if (this == pOther) {
         return true;
      } else if (!(pOther instanceof TextComponent)) {
         return false;
      } else {
         TextComponent textcomponent = (TextComponent)pOther;
         return this.text.equals(textcomponent.getText()) && super.equals(pOther);
      }
   }
