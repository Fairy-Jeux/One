...
public class TranslatableComponent extends BaseComponent implements ContextAwareComponent {
   ...
   public boolean equals(Object pOther) {
      if (this == pOther) {
         return true;
      } else if (!(pOther instanceof TranslatableComponent)) {
         return false;
      } else {
         TranslatableComponent translatablecomponent = (TranslatableComponent)pOther;
         return Arrays.equals(this.args, translatablecomponent.args) && this.key.equals(translatablecomponent.key) && super.equals(pOther);
      }
   }
