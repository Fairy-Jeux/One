...
public class KeybindComponent extends BaseComponent {
   ...
   public boolean equals(Object pOther) {
      if (this == pOther) {
         return true;
      } else if (!(pOther instanceof KeybindComponent)) {
         return false;
      } else {
         KeybindComponent keybindcomponent = (KeybindComponent)pOther;
         return this.name.equals(keybindcomponent.name) && super.equals(pOther);
      }
   }
